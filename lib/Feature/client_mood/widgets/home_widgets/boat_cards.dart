      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Icon(Icons.star, size: 14, color: Color(0xFFFFB020)),
            ...
            // Price row: per-day price on the left, per-hour/per-day
            ...
            Row(
              ...
              children: [
                ...
                //       ),
                //       Text(
                //         '${boat.currency}${boat.pricePerDay.toStringAsFixed(0)} per day',
                //         style: AppTextStyles.bodySmall,
                //       ),
                //     ],
                //   ),
